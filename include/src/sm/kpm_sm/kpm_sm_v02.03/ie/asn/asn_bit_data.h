 ...
 */
asn_bit_data_t *asn_bit_data_new_contiguous_kpm_v2_03(const void *data, size_t size_bits);
 ...
 */
int32_t asn_get_few_bits_kpm_v2_03(asn_bit_data_t *, int get_nbits);

/* Undo the immediately preceding "get_few_bits" operation */
void asn_get_undo_kpm_v2_03(asn_bit_data_t *, int get_nbits);
 ...
 * extracted due to EOD or other conditions.
 */
int asn_get_many_bits_kpm_v2_03(asn_bit_data_t *, uint8_t *dst, int right_align,
			int get_nbits);

/* Non-thread-safe debugging function, don't use it */
char *asn_bit_data_string_kpm_v2_03(asn_bit_data_t *);
...
int asn_put_few_bits_kpm_v2_03(asn_bit_outp_t *, uint32_t bits, int obits);

/* Output a large number of bits */
int asn_put_many_bits_kpm_v2_03(asn_bit_outp_t *, const uint8_t *src, int put_nbits);
 ...
 */
int asn_put_aligned_flush_kpm_v2_03(asn_bit_outp_t *);
