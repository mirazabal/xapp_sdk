...
extern asn_TYPE_descriptor_t asn_DEF_REAL_kpm_v3_00;
extern asn_TYPE_operation_t asn_OP_REAL_kpm_v3_00;

#define REAL_free ASN__PRIMITIVE_TYPE_free_kpm_v3_00

#if !defined(ASN_DISABLE_PRINT_SUPPORT)
asn_struct_print_f REAL_print_kpm_v3_00;
...
per_type_decoder_f REAL_decode_aper_kpm_v3_00;
per_type_encoder_f REAL_encode_aper_kpm_v3_00;
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
asn_random_fill_kpm_v3_00_f  REAL_random_fill_kpm_v3_00;
...
ssize_t REAL__dump_kpm_v3_00(double d, int canonical, asn_app_consume_bytes_f *cb, void *app_key);
 ...
 */
int asn_REAL2double_kpm_v3_00(const REAL_t *real_ptr, double *d);
int asn_double2REAL_kpm_v3_00(REAL_t *real_ptr, double d);
 ...
 */
int asn_double2float_kpm_v3_00(double d, float *outcome);
