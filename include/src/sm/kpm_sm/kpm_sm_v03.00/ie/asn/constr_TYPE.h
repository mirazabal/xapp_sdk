...
#else
typedef void (asn_random_fill_kpm_v3_00_f)(void);
...
asn_outmost_tag_f asn_TYPE_outmost_tag_kpm_v3_00;
...
typedef struct asn_TYPE_operation_s {
    ...
    xer_type_decoder_f *xer_decode_kpm_v3_00r;      /* Generic XER decoder */
    xer_type_encoder_f *xer_encode_kpm_v3_00r;      /* [Canonical] XER encoder */
    ...
    per_type_decoder_f *aper_decode_kpm_v3_00r;     /* Aligned PER decoder */
    per_type_encoder_f *aper_encode_kpm_v3_00r;     /* Aligned PER encoder */
    asn_random_fill_kpm_v3_00_f *random_fill;       /* Initialize with a random value */
 ...
 * (See also xer_fprint_kpm_v3_00() in xer_encode_kpm_v3_00r.h)
 */
int asn_fprint_kpm_v3_00(FILE *stream, /* Destination stream descriptor */
