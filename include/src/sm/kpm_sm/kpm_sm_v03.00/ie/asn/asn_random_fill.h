...
} asn_random_fill_kpm_v3_00_result_t;
typedef asn_random_fill_kpm_v3_00_result_t(asn_random_fill_kpm_v3_00_f)(
 ...
 */
int asn_random_fill_kpm_v3_00(const struct asn_TYPE_descriptor_s *td, void **struct_ptr,
                    size_t approx_max_length_limit);

/*
 * Returns a random number between min and max.
 */
intmax_t asn_random_between_kpm_v3_00(intmax_t min, intmax_t max);
