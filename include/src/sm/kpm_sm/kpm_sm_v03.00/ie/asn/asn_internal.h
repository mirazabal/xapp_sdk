...
int get_asn1c_environment_version_kpm_v3_00(void);	/* Run-time version */
...
#else	/* !C99 */
void CC_PRINTFLIKE(1, 2) ASN_DEBUG_f_kpm_v3_00(const char *fmt, ...);
#define	ASN_DEBUG	ASN_DEBUG_f_kpm_v3_00
#endif	/* C99 */
...
asn__format_to_callback_kpm_v3_00(
