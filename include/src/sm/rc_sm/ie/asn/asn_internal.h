...
int get_asn1c_environment_version_rc_v1_03(void);	/* Run-time version */
...
#else	/* !C99 */
void CC_PRINTFLIKE(1, 2) ASN_DEBUG_f_rc_v1_03(const char *fmt, ...);
#define	ASN_DEBUG	ASN_DEBUG_f_rc_v1_03
#endif	/* C99 */
...
asn__format_to_callback_rc_v1_03(
