...
#else
typedef void (asn_random_fill_rc_v1_03_f)(void);
...
asn_outmost_tag_f asn_TYPE_outmost_tag_rc_v1_03;
...
typedef struct asn_TYPE_operation_s {
    ...
    per_type_decoder_f *aper_decode_rc_v1_03r;     /* Aligned PER decoder */
    per_type_encoder_f *aper_encode_rc_v1_03r;     /* Aligned PER encoder */
    asn_random_fill_rc_v1_03_f *random_fill;       /* Initialize with a random value */
