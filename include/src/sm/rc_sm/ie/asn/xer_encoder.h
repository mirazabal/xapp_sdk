...
/* Flags used by the xer_encode_rc_v1_03() and (*xer_type_encoder_f), defined below */
enum xer_encode_rc_v1_03r_flags_e {
	/* Mode of encoding */
 ...
 */
asn_enc_rval_t xer_encode_rc_v1_03(const struct asn_TYPE_descriptor_s *type_descriptor,
                          const void *struct_ptr, /* Structure to be encoded */
                          enum xer_encode_rc_v1_03r_flags_e xer_flags,
 ...
 */
int xer_fprint_rc_v1_03(FILE *stream, const struct asn_TYPE_descriptor_s *td,
...
enum xer_equivalence_e xer_equivalent_rc_v1_03(
