 ...
 */
asn_dec_rval_t xer_decode_rc_v1_03(
 ...
 * Used by more specialized functions, such as OCTET_STRING_decode_xer_utf8_rc_v1_03
 * and others. This function should not be used by applications, as its API
 * is subject to changes.
 */
asn_dec_rval_t xer_decode_rc_v1_03_general(
    const asn_codec_ctx_t *opt_codec_ctx,
...
ssize_t xer_next_token_rc_v1_03(int *stateContext,
	const void *buffer, size_t size, pxer_chunk_type_e *_ch_type);

/*
 * This function checks the buffer against the tag name is expected to occur.
 */
  typedef enum xer_check_tag_rc_v1_03 {
  ...
  } xer_check_tag_rc_v1_03_e;
xer_check_tag_rc_v1_03_e xer_check_tag_rc_v1_03(const void *buf_ptr, int size,
		const char *need_tag);
 ...
 */
size_t xer_whitespace_span_rc_v1_03(const void *chunk_buf, size_t chunk_size);

/*
 * Skip the series of anticipated extensions.
 */
int xer_skip_unknown_rc_v1_03(xer_check_tag_rc_v1_03_e tcv, ber_tlv_len_t *depth);
