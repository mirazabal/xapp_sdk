 ...
 */
asn_struct_free_f SET_OF_free_rc_v1_03;

#if !defined(ASN_DISABLE_PRINT_SUPPORT)
asn_struct_print_f SET_OF_print_rc_v1_03;
...
per_type_decoder_f SET_OF_decode_aper_rc_v1_03;
per_type_encoder_f SET_OF_encode_aper_rc_v1_03;
#endif  /* !defined(ASN_DISABLE_APER_SUPPORT) */

#if !defined(ASN_DISABLE_RFILL_SUPPORT)
asn_random_fill_rc_v1_03_f SET_OF_random_fill_rc_v1_03;
#endif  /* !defined(ASN_DISABLE_RFILL_SUPPORT) */

extern asn_TYPE_operation_t asn_OP_SET_OF_rc_v1_03;
...
struct _el_buffer * SET_OF__encode_sorted_rc_v1_03(
        const asn_TYPE_member_t *elm,
        const asn_anonymous_set_ *list,
        enum SET_OF__encode_method method);

void SET_OF__encode_sorted_rc_v1_03_free(
