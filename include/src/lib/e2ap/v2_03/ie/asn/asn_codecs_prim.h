...
ber_type_decoder_f ber_decode_e2ap_v2_03_primitive;
der_type_encoder_f der_encode_e2ap_v2_03_primitive;
#endif  /* !defined(ASN_DISABLE_BER_SUPPORT) */

#if !defined(ASN_DISABLE_XER_SUPPORT)
/*
 * A callback specification for the xer_decode_e2ap_v2_03_primitive() function below.
 */
enum xer_pbd_rval {
 ...
 */
asn_dec_rval_t xer_decode_e2ap_v2_03_primitive(
